...
>>> from stock_reminder.stock import Stock
>>> exchange = {"GOOG": Stock("GOOG"), "AAPL": Stock("AAPL")}
>>> for key in sorted(exchange.keys()):
...    print(key, exchange[key])
...    
AAPL       <stock_reminder.stock.Stock object at 0x0...>
GOOG       <stock_reminder.stock.Stock object at 0x0...>
...
>>> from stock_reminder.reader import ListReader
...
>>> from stock_reminder.alert import Alert
>>> from stock_reminder.rule import PriceRule
>>> from stock_reminder.action import PrintAction
...
>>> from stock_reminder.processor import Processor
